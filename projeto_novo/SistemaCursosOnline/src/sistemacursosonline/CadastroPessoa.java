...
public class CadastroPessoa extends javax.swing.JInternalFrame {
    ...
    private void btnCadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCadastrarMouseClicked
        try {
            ...
            atividade.setSelectedItem(null);
            situacao.setSelectedItem(null);
        } catch (SQLException ex) {
            Logger.getLogger(CadastroPessoa.class.getName()).log(Level.SEVERE, null, ex);
            if(atividade.getSelectedItem().equals("Aluno")){
                JOptionPane.showMessageDialog(rootPane, "Aluno " +nome.getText()+ " não foi cadastrado!");
            } else if (atividade.getSelectedItem().equals("Professor")){
                JOptionPane.showMessageDialog(rootPane, "Professor "+nome.getText()+" não foi cadastrado!");
            }
        }
        try {  
            Connection con = BancoClass.conexaoBanco();
            ...
            JOptionPane.showMessageDialog(rootPane, "Pessoa não registrada!");
    ...
    private void btnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseClicked
        try {
            Connection con = BancoClass.conexaoBanco();
            String sql = "UPDATE pessoa SET cpf_cnpj = ?, nome = ?, matricula = ?, email = ?, idade = ?, telefone = ?, endereco = ?, atividade = ?, situacao = ? WHERE id_pessoa = ?";
            PreparedStatement stmt = con.prepareStatement(sql);
            ...
            Logger.getLogger(CadastroPessoa.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(rootPane, nome.getText()+" não pode ser editado(a)!");
        }
